{% macro init_s3_sources() -%}
    ...
    {% set sources = [
        ...
        ,URL
        ,Thumbnail
        FROM s3(\'https://storage.yandexcloud.net/rzv-final-test-dez23/data/2022-01-08.csv\'
            , \'CSVWithNames\'
        ...
        ,ID as id
        ,name
        FROM s3(\'https://storage.yandexcloud.net/rzv-final-test-dez23/data/bgg-19m-reviews.csv\'
            , \'CSVWithNames\'
